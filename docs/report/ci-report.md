...
- 테스트 파일 4 · 테스트 24 (통과 24 / 실패 0 / 건너뜀 0)
- TC 문서 자동시험 연결 3 / 6
...
|---|---|---|
| `TC_AUD_AudioGraph.md` | — (검사·시연 레인) | — |
| `TC_COR_CoreStateSettings.md` | ✅ 12/15 | `tests/sceneState.test.ts` · `tests/settings.test.ts` |
| `TC_QLT_Adaptation.md` | ✅ 6/9 | `tests/adaptation.test.ts` |
| `TC_SCN_WorldRender.md` | — (검사·시연 레인) | — |
...
|---|---|---|---|
| AUD | 8 | 0 | TC-AUD-01 · TC-AUD-02 · TC-AUD-03 · TC-AUD-04 · TC-AUD-05 · TC-AUD-06 · TC-AUD-07 · TC-AUD-08 |
| COR | 15 | 12 | TC-COR-13 · TC-COR-14 · TC-COR-15 |
| QLT | 9 | 6 | TC-QLT-07 · TC-QLT-08 · TC-QLT-09 |
| SCN | 7 | 0 | TC-SCN-01 · TC-SCN-02 · TC-SCN-03 · TC-SCN-04 · TC-SCN-05 · TC-SCN-06 · TC-SCN-07 |
